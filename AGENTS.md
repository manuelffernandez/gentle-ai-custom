...
- **Purpose**: generate or regenerate PR content from the committed diff; refresh remote refs automatically, validate remote head state read-only, and create or update the PR on GitHub after the content approval step.
