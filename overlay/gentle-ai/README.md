...
- La regla de exploración inline de 4+ archivos vive en `policy/maintenance-intent.md`: por defecto se delega, pero el usuario puede pedir inline esa exploración puntual.
