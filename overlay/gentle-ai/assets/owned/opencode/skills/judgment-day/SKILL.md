---
name: judgment-day
description: "Trigger: judgment day, dual review, adversarial review, juzgar. Run blind dual review, fix confirmed issues, re-judge, and close terminal states with a retrospective."
license: Apache-2.0
metadata:
...
- When a loop reaches a terminal state, the runtime `judgment-day` hook runs the repo-owned `judgment-retrospective` skill before closing; persist only compact semantic knowledge.
