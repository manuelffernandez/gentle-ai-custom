...
Follow [../../_shared/review-ledger-contract.md](../../_shared/review-ledger-contract.md) for the ledger row shape, severity/status model, and scoped re-review rules. Do not add a separate findings table or legacy warning layer here.
